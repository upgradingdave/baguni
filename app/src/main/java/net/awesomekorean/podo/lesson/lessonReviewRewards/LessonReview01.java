...
public class LessonReview01 extends LessonInit implements LessonItem, LessonReview, Serializable {
    ...
    private String[] baseForm = {
            "재미있다", "춥다", "오다", "바쁘다", "피곤하다", "일어나다", "살다", "싸다", "비싸다", "사다", "팔다"};

    private String[][] conjugation = {
            {"재미있었어요", "재미있을 거예요", "-", "-", "-", "재미있어서"},
            {"추웠어요", "추울 거예요", "-", "안 추워요 / 춥지 않아요", "-", "추워서"},
            {"왔어요", "올 거예요", "오고 있어요", "안 와요 / 오지 않아요", "못 와요", "와서"},
            {"바빴어요", "바쁠 거예요", "-", "안 바빠요 / 바쁘지 않아요", "바빠서"},
            {"피곤했어요", "피곤할 거예요", "-", "안 피곤해요 / 피곤하지 않아요", "-", "피곤해서"},
            {"일어났어요", "일어날 거예요", "일어나고 있어요", "안 일어나요 / 일어나지 않아요", "못 일어나요", "일어나서"},
            {"살았어요", "-", "살고 있어요", "-", "-", "-"},
            {"쌌어요", "쌀 거예요", "-", "안 싸요 / 싸지 않아요", "-", "싸서"},
            {"비쌌어요", "비쌀 거예요", "-", "안 비싸요 / 비싸지 않아요", "-", "비싸서"},
            {"샀어요", "살 거예요", "사고 있어요", "안 사요 / 사지 않아요", "못 사요", "사서"},
            {"팔았어요", "팔 거예요", "팔고 있어요", "안 팔아요 / 팔지 않아요", "못 팔아요", "팔아서"}
    };
    ...
    private String[][] translate = {
            ...
            {"I was busy", "I will be busy", "-", "I'm not busy", "Because he comes"},
            {"I was tired", "I will be tired", "-", "I'm not tired", "-", "Because I'm tired"},
            {"I woke up", "It will happen", "It's happening", "He is not wake up", "I can't wake up", "Because I'm tired"},
            {"I lived", "-", "I'm living", "-", "-", "-"},
