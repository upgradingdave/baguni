...
public class LessonHangulConsonant implements Hangul {
    ...
    String hangulIntro = "Korean only has people14 consonants and people5 double consonants. We can make the audio_small of each consonant by using articulators like the lips, tongue, mouth, throat and nose. That's why we should think about the correct position of each articulator. This will make you pronounce Korean like a native Korean. Some of consonants could be similar to sounds in your language. But some of the others could be difficult to pronounce exactly right because you have never made that audio_small in your life. Your muscles in your mouth may not be strong enough to make that new audio_small yet. Fortunately, we can train our muscles with practice.</b> Let's warm up your mouth before we start.";
