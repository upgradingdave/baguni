...
class LessonHangulBatchim implements Hangul{
    ...
    String[] hangulExplain = {
            ...
            "However, every languages have some words that have same pronunciation but different meaning. It will help english to reduce the number of sound that we should make. Even though it has same sound, we can know enough its different meanings with spelling and the situation.",
